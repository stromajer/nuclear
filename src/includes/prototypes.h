...
void vwrite_room_except_both(RM_OBJECT, UR_OBJECT, UR_OBJECT, const char *,
                             ...)
...
void record_last_command(UR_OBJECT, enum cmd_value, size_t);
...
char *nominativ_m(char *);
char *genitiv_m(char *);
char *dativ_m(char *);
char *akuzativ_m(char *);
char *lokal_m(char *);
char *instrumental_m(char *);
char *nominativ_z(char *);
char *genitiv_z(char *);
char *dativ_z(char *);
char *akuzativ_z(char *);
char *lokal_z(char *);
char *instrumental_z(char *);
...
void recount_users(UR_OBJECT, int);
...
void nl_transfer(NL_OBJECT nl, char *name, char *pass, enum lvl_value lvl,
                 char *inpstr);
...
int add_command(int);
int rem_command(int);
int add_user_node(char *, int);
int rem_user_node(char *);
void add_user_date_node(char *, char *);
int user_list_level(char *, int);
...
int has_room_key(char *, RM_OBJECT);
...
int personal_room_store(char *, int, RM_OBJECT);
...
void midcpy(const char *, char *, size_t, size_t);
