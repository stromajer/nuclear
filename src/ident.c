...
#define HOSTBIN    "/home/angel/"
#define TALKERNAME "Angel"
#define SERVER     "localhost"
#define HOSTPORT   "7000"
#define USERNAME   "Identuser"
#define PASSWORD   "ccidentcc"
#define MAX_WORDS 10
#define WORD_LEN 150
...
static char *get_proc(char *site);
...
authenticate_host(int host_socket)
{
  ...
  for (;;) {
    ...
    if (strstr(inpstr, "tinue:") && stage == 3) {
      sprintf(buffer,"\n");
      send(host_socket, buffer, strlen(buffer), 0);
      break;
    }
